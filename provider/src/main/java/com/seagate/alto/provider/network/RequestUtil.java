...
public class RequestUtil {
    ...
    public static ArrayList<com.dropbox.core.http.HttpRequestor.Header> addAuthHeader(/*@Nullable*/ArrayList<com.dropbox.core.http.HttpRequestor.Header> headers,
                                                                                      String accessToken) {
        if (headers == null) headers = new ArrayList<com.dropbox.core.http.HttpRequestor.Header>();
        headers.add(new com.dropbox.core.http.HttpRequestor.Header("Authorization", "Bearer " + accessToken));
        return headers;
    }

    public static ArrayList<com.dropbox.core.http.HttpRequestor.Header> addUserAgentHeader(/*@Nullable*/ArrayList<com.dropbox.core.http.HttpRequestor.Header> headers,
    ...
    public static com.dropbox.core.http.HttpRequestor.Header buildUserAgentHeader(DbxRequestConfig requestConfig) {
        return new com.dropbox.core.http.HttpRequestor.Header("User-Agent", requestConfig.clientIdentifier + " Dropbox-Java-SDK/" + DbxSdkVersion.Version);
    }

    /**
     * Convenience function for making HTTP GET requests.
     */
    public static com.dropbox.core.http.HttpRequestor.Response startGet(DbxRequestConfig requestConfig, String accessToken, String host, String path,
                                                  /*@Nullable*/String/*@Nullable*/[] params,
                                                  /*@Nullable*/ArrayList<com.dropbox.core.http.HttpRequestor.Header> headers)
     ...
     */
    public static com.dropbox.core.http.HttpRequestor.Uploader startPut(DbxRequestConfig requestConfig, String accessToken,
     ...
     */
    public static com.dropbox.core.http.HttpRequestor.Response startPostNoAuth(DbxRequestConfig requestConfig, String host,
                                                                               String path,
                                                         /*@Nullable*/String/*@Nullable*/[] params,
                                                         /*@Nullable*/ArrayList<com.dropbox.core.http.HttpRequestor.Header> headers)
            throws DbxException.NetworkIO {
        ...
        if (headers == null) headers = new ArrayList<com.dropbox.core.http.HttpRequestor.Header>();
        headers.add(new com.dropbox.core.http.HttpRequestor.Header("Content-Type", "application/x-www-form-urlencoded; charset=utf-8"));
     ...
     */
    public static com.dropbox.core.http.HttpRequestor.Response startPostRaw(DbxRequestConfig requestConfig, String host,
                                                                            String path,
                                                                            byte[] body,
                                                      /*@Nullable*/ArrayList<com.dropbox.core.http.HttpRequestor.Header> headers)
            throws DbxException.NetworkIO {
        ...
        headers = addUserAgentHeader(headers, requestConfig);
        headers.add(new com.dropbox.core.http.HttpRequestor.Header("Content-Length", Integer.toString(body.length)));

        try {
            com.dropbox.core.http.HttpRequestor.Uploader uploader = requestConfig.httpRequestor.startPost(uri, headers);
            try {
    ...
    public static abstract class RouteSpecificErrorMaker<T extends Throwable> {
        public abstract T makeError(ErrorWrapper ew);
    }

    public static byte[] loadErrorBody(com.dropbox.core.http.HttpRequestor.Response response)
            throws DbxException.NetworkIO {
    ...
    public static DbxException unexpectedStatus(com.dropbox.core.http.HttpRequestor.Response response)
    ...
    public static abstract class ResponseHandler<T> {
        public abstract T handle(com.dropbox.core.http.HttpRequestor.Response response) throws DbxException;
    }
    ...
    public static <T> T doGet(DbxRequestConfig requestConfig, String accessToken, String host, String path,
            ...
            throws DbxException {
        com.dropbox.core.http.HttpRequestor.Response response = startGet(requestConfig, accessToken, host, path, params, headers);
        try {
    ...
    public static <T> T doPostNoAuth(DbxRequestConfig requestConfig, String host, String path,
                                     ...
                                     ResponseHandler<T> handler)
            throws DbxException {
        com.dropbox.core.http.HttpRequestor.Response response = startPostNoAuth(requestConfig, host, path, params, headers);
        return finishResponse(response, handler);
    }

    public static <T> T finishResponse(com.dropbox.core.http.HttpRequestor.Response response, ResponseHandler<T> handler)
            throws DbxException {
        try {
            return handler.handle(response);
        } finally {
    ...
    public static String getFirstHeader(com.dropbox.core.http.HttpRequestor.Response response, String name)
            throws DbxException {
    ...
    public static /*@Nullable*/String getFirstHeaderMaybe(com.dropbox.core.http.HttpRequestor.Response response, String name)
            throws DbxException {
        List<String> values = response.headers.get(name);
